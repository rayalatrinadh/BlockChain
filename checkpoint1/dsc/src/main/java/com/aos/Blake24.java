...
public class Blake24 {
    ...
    private static class Node {
        ...
        private byte[] rootOutputBytes(int outLen){
            ...
            throw new IllegalStateException("Uh oh something has gone horribly wrong. Please create an issue on https://github.com/rctcwyvrn/Blake24");
        }
    }
    ...
    /**
     * Generate the Blake24 hash for the current tree with the default byte length of 32
     * @return The byte array representing the hash
     */
    public byte[] digest(){
