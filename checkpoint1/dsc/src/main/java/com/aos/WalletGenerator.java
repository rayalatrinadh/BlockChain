...
public class WalletGenerator {
    ...
    public WalletGenerator() {
        ...
        // } else if (privatekey_base58encoded == null || privatekey_base58encoded.isEmpty() || privatekey_base58encoded.isBlank()) {
    ...
    public void goKeyPair() {
        try {
            ...
            System.out.println("New keys generated and stored, public key to dsc-config.yaml and private key to dsc-key.yaml in\r\n" + //
                    "local folder");
   ...
   @Deprecated
    ...
    public String send(double amount, String recipientAddress) throws Exception
    {
        ...
        Transaction t = new Transaction( publickey, Base58.decode(recipientAddress), generateTransactionID() ,balance, System.currentTimeMillis());
