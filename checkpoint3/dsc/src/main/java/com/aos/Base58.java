 ...
 * represented using
 * base-256 digits, convert the number to be represented using base-58 digits,
 * preserve the exact
 * number of leading zeros (which are otherwise lost during the mathematical
 * operations on the
 * numbers), and finally represent the resulting base-58 digits as alphanumeric
 * ASCII characters.
 */
public class Base58 {
